...
<main>
  ...
  <div class="screen">
    <button class="icon-button" on:click={() => goto('/3Works/Pictures')}>
    ...
    <button class="icon-button" on:click={() => goto('/3Works/Logos')}>
      <svg class="icon-svg" viewBox="0 0 24 24">
        <path d="M12 2L2 7h20L12 2zm0 2.18L18.09 7H5.91L12 4.18zM4 9v10h4V9H4zm6 0v10h10V9H10z"/>
      </svg>
      <div class="icon-label">Logos</div>
    </button>

    <button class="icon-button" on:click={() => goto('/3Works/Programs')}>
      <svg class="icon-svg" viewBox="0 0 24 24">
